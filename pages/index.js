  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="mx-5">
          <p className="mb-4">
            I'm a junior Front-Dnd Developer and Tester who excels at
          ...
          <p className="mb-4">
            ...
            in the hospitality industry defining and solving problems, building
            relatonships with stakeholders, and utilising agile practises
            (including Scrum) for staff, service and system development. I'm
            also qualified in person-centred counselling, and during 2.5 years as
            a volunteer bereavement counsellor I deepened my ability to
