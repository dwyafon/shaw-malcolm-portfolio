...
export default function Home() {
  return (
    <>
      ...
      <Navbar />
      <div className='flex'>
        <div className='flex sm:flex-col sm:flex-nowrap '>
          <div className='flex sm:flex-col lg:flex-row lg:flex-nowrap lg:mx-24'>
            ...
            <div className='mx-5 sm:mx-4 md:mx-16 lg:mx-24 xl:mx-36 xxl:mx-48'>
              <p className='mb-4'>
                ...
                with JavaScript, TypeScript, and React. I'm also a huge advocate
                of testing and writing testable code. Currently apprenticing at{' '}
                <a
              ...
              <p className='mb-4'>
                My background is highly leverageable for web development: 17
                years in the hospitality industry defining and solving problems,
                building relatonships with stakeholders, and utilising agile
                practises (including Scrum) for staff, service and system
                development. I'm also qualified in person-centred counselling,
                and during 2.5 years as a volunteer bereavement counsellor I
                deepened my ability to empathise and listen.
              </p>
              <p className='mb-4'>
                I'm looking for a company with a great culture that cares about
                testing and TDD, clean code, efficient CI/CD practises, and
                agile methodologies.
              </p>
